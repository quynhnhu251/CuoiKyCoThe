...
public class CustomGridAdapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null){
            ...
            holder.txtRom = view.findViewById(R.id.txtPhong);
        ...
        holder.txtSubjects.setText(inforTimeTable.getSubject());
        holder.txtRom.setText(inforTimeTable.getRoom());
        holder.txtRomNumber.setText(inforTimeTable.getRoomNumber());
